...
const skills = [
  { name: 'HTML5', icon: <FaHtml5 className="text-orange-800" /> },
  { name: 'CSS3', icon: <FaCss3Alt className="text-blue-700" /> },
  { name: 'JavaScript', icon: <FaJs className="text-yellow-600" /> },
  { name: 'React', icon: <FaReact className="text-blue-700" /> },
  { name: 'Next.js', icon: <SiNextdotjs className="text-black" /> },
  { name: 'Node.js', icon: <FaNodeJs className="text-green-800" /> },
...
const Skills = () => {
  return (
    <section id='skills' className="min-h-screen flex items-center justify-center px-6 bg-green-100">
