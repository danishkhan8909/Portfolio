...
const Contact = () => {
  return (
    <section id='contact' className="min-h-screen flex items-center justify-center px-6 bg-green-100">
      <div className="max-w-3xl w-full text-center">
        ...
        <form className="space-y-6">
          ...
          <button
            type="submit"
            className="bg-black text-white px-6 py-3 rounded-lg text-lg hover:bg-yellow-700 transition duration-300"
          >
            Send Message
          </button>
        </form>
